...
public class AnimalFicheController {
    ...
    public void valider() {
        try {
            if (null == tfNom || null == spTaille || null == spPoids || null == cbDangerous || null == dpDdn || null == cmbType ||
            null == tfNom.getText() || null == spTaille.getValue() || null == spPoids.getValue() || null == dpDdn.getValue() || null == dpDdn.getValue() ||
            tfNom.getText().isBlank()) {
                afficherAlerteInformations();
            } else {
    ...
    private void afficherAlerteInformations() {
