...
public class AnimalListeController {
    ...
    @FXML
    public TextField txtRechercheAnimal;
    ...
    public void initialize() {
        try {
            ...
            this.txtRechercheAnimal.textProperty().addListener(obs -> {
                animalFilteredList.setPredicate(a -> a.getNom().toLowerCase().startsWith(txtRechercheAnimal.getText().toLowerCase()));
            });
