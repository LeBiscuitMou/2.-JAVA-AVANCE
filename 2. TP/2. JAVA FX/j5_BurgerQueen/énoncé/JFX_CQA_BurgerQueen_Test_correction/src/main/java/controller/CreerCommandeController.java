...
public class CreerCommandeController extends AbstractController {
     ...
     */
    final ObservableList<TypeProduit> oLstTypeProduits = FXCollections.observableArrayList();
    /**
     * Liste observable de produits.
     */
    final ObservableList<Produit> oLstProduits = FXCollections.observableArrayList();
    /**
     * Liste observable de produits.
     */
    final ObservableList<Entry<Produit, Integer>> oLstProduitsCommande = FXCollections.observableArrayList();
    @FXML
    VBox barreMenu;
    @FXML
    ...
    private boolean predicatFiltreLstProduits(String newValue, Produit produit) {
        ...
        return produit.getNom().toLowerCase().contains(lowerCaseFilter) && produit.getTypeProduit().equals(this.cbxTypeProduit.getSelectionModel().getSelectedItem());
    }
...
//        }
    ...
    private Boolean predicatFiltreLstProduits(TypeProduit newValue, Produit produit) {
        ...
        return produit.getTypeProduit().equals(newValue);
    }
