package net.ent.etrs.geststage.start;
...
public class Lanceur extends Application {
    ...
    public void start(Stage stage) throws Exception {
        scene = new Scene(FXMLLoader.load(Objects.requireNonNull(Lanceur.class.getResource("/views/accueil.fxml"))));
        stage.setScene(scene);
        stage.getIcons().add(new Image(Objects.requireNonNull(Lanceur.class.getResourceAsStream("/image.jpeg"))));
        stage.setTitle("Projet de dingue !");
        stage.show();
    }
