...
@Entity
@Table(name = "FABRIQUANT", uniqueConstraints = @UniqueConstraint(columnNames = {"nom"}, name = "uk__fabriquant__nom"))
...
public class Fabriquant extends AbstractEntity {
    ...
    @Setter
    //BV
    @NotNull(message = "la date creation doit être référencé")
    @Past(message = "la date creation doit être dans le passé")
    //JPA
